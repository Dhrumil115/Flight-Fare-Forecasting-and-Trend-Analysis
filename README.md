# Flight Fare Forecasting & Trend Analysis
Flight Fare Forecasting & Trend Analysis is a machine learning project that aims to predict flight prices based on various factors such as route duration, source, destination, arrival, and departure times. Using a dataset of over 300,000 flight records, we employ different machine learning algorithms including Decision Tree, Logistic Regression, and Random Forest to forecast flight prices. Our model achieved an impressive 96% accuracy with the Decision Tree algorithm.
